...
export default function DropDownPolicyMarketing({checkMarketing,setCheckMarketing}){
    ...
    <View style={styles.container}>
      <View style={styles.itemContainer}>      
        <View style={styles.row}>
          <TouchableOpacity  style={styles.checkContainer} activeOpacity={1} onPress={()=>{setCheckMarketing(!checkMarketing)}}>
            {
              checkMarketing?
          ...
          <Text style={styles.title}>마케팅 이용에 대한 동의 (선택)</Text>
          {
            dropDown ? 
