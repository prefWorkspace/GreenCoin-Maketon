...
export default function PersonalPolicyScreen() {
  navigationBackHandler();
    return (
      <ScrollView style={styles.container}>
        <CommonTitleBar title={"이용약관"}  rightOption={"close"}></CommonTitleBar>
        <View style={styles.contentContainer}>
          <Text style={styles.title}>서비스 이용약관</Text>
          <Text style={styles.title}>
          제1조(목적){"\n"}
이 약관은 용된다 회사(전자거래 사업자)가 운영하는 용된다(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다. ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
{"\n"}{"\n"}
제2조(정의){"\n"}{"\n"}
① “몰” 이란 용된다 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
{"\n"}② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
{"\n"}③ ‘회원’이라 함은 “몰”에 개인정보를 제공하여 회원등록을 한 자로서, “몰”의 정보를 지속적으로 제공받으며, “몰”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
{"\n"}④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.
{"\n"}{"\n"}
제3조 (약관의 명시와 개정){"\n"}{"\n"}
① “몰”은 이 약관의 내용과 상호, 영업소 소재지, 대표자의 성명, 사업자등록번호, 연락처(전화, 팩스, 전자우편 주소 등) 등을 이용자가 알 수 있도록 용된다 사이버몰의 초기 서비스화면(전면)에 게시합니다.
...
{"\n"}{"\n"}
※ 용된다 쇼핑몰은 공정거래위원회에서 심의한 표준약관을 사용하고 있음.
{"\n"}{"\n"}
          </Text>
        </View>
      </ScrollView>
