...
export default function WriteReviewImageList({imageList , setImageList}) {

  const clickOpenGallery = () =>{
    ImagePicker.openPicker({  multiple: true ,mediaType:'photo', compressImageQuality : 0.6,width:600,height:600}).then(images => {
