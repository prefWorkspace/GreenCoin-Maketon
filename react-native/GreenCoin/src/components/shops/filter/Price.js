 ...
 return (
    <View style={styles.markerContainer}>
          <View style={styles.rangeContainer}>
            <Text style={styles.markerLabel}>{numberWithCommas(currentValue)}</Text>
...
export default function Price({price,setPrice}) {
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.valueAbleLabel}>{numberWithCommas(price[0])}원 이상~{numberWithCommas(price[1])}원 이하</Text>
        </View>
        <View style={styles.sliderContainer}>
            <MultiSlider
                ...
                min={0}
                max={300000}
                onValuesChangeFinish={(values) => {setPrice(values)}}
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.pivotLabel}>1,000원 이상</Text>
          <Text style={styles.pivotLabelRight}>300,000원 이하</Text>
        </View>
      </View>
      </View>
    );
